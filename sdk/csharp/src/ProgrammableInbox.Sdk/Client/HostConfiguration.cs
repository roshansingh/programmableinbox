...
{
    /// <summary>
    /// Provides hosting configuration for ProgrammableInbox.Sdk
    /// </summary>
    public partial class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new CreateEmailInbox201ResponseJsonConverter());
            _jsonOptions.Converters.Add(new CreateEmailInboxRequestJsonConverter());
            _jsonOptions.Converters.Add(new EmailInboxJsonConverter());
            _jsonOptions.Converters.Add(new EmailMessageJsonConverter());
            _jsonOptions.Converters.Add(new ErrorResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetEmailInbox200ResponseJsonConverter());
            ...
            _services.AddSingleton<EmailInboxesApiEvents>();
            ...
            Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IEmailInboxesApi, EmailInboxesApi>("ProgrammableInbox.Sdk.Api.IEmailInboxesApi", client));
