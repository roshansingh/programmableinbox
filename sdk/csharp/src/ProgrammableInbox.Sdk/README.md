...
inputSpec: sdk/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{316EE9BB-A75F-4585-875A-8F342FDC7C29}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            ICreateEmailInboxApiResponse apiResponse = await api.CreateEmailInboxAsync("todo");
            CreateEmailInbox201Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: ProgrammableInbox Email Inboxes API
- appVersion: 1.0.0
- appDescription: Email inbox management endpoints with API key support
