...
from programmableinbox.configuration import Configuration
from programmableinbox.api_response import ApiResponse, T as ApiResponseT
import programmableinbox.models
from programmableinbox import rest
from programmableinbox.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(programmableinbox.models, klass)
