...
echo "  1. As $DEPLOY_USER: place secrets/app.env and secrets/storagebox_id_ed25519 under $SRV_DIR/secrets/ (mode 0600)."
echo "  2. Copy deploy/docker-compose.yml and deploy/Caddyfile into $SRV_DIR/."
