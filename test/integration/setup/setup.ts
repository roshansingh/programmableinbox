...
process.env.EMAIL_INBOX_ALLOWED_DOMAINS = 'test.dev,corp.com,example.com,case.dev'
...
// .env.test that had truncated AUTH_JWT_SECRET to "test-jwt-secret" (15 chars) put
...
process.env.AUTH_JWT_SECRET = 'integration-test-jwt-secret-at-least-16-chars'
process.env.RESEND_WEBHOOK_SECRET = 'integration-test-webhook-secret'
...
process.env.HEALTHZ_DETAIL_SECRET = 'integration-test-healthz-secret'
// A placeholder on purpose: the suite must never reach the real Resend API.
process.env.RESEND_API_KEY = 're_integration_test_placeholder'
